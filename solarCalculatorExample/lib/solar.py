...
from lib.parser import get_data
...
class DataSource(Component):
    ...
    def __init__(self, fns=None, start_time=10, end_time=15, efficiency=0.95):
        ...
        if fns == None:
            root = "/home/piaktipik/Desktop/simplePower/SimplePowerModel/solarCalculatorExample/lib/"
            fns = [root + "data/cleveland.csv", root + "data/akron.csv", root + "data/mansfield.csv"]
